...
Secret changes through modify are Rust-SDK and CLI only for now. See [Modify and resize](/sandboxes/lifecycle#modify-and-resize) for how changes are applied.
